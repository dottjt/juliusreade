...
draft = false
slug = "verifiable-systems-work-please-get-yourself-a-verifiable-system"
title = "Verifiable Systems Work. Please Get Yourself A Verifiable System"


thumbnail = "/img/blog/11.png"
thumbnailalt = "Perspective Doesn't Work. Though A Verifiable System Will Instead"
...
Maybe you feel unable to help yourself become successful, either due to lack of knowledge, or maybe even ability.
...
And of course, these are just words to you.
...
To let you know that things don't have to continue the way they are, and that the process is neither hard, nor difficult.

To tell you that it really is all in your head, and that while this fact doesn't lessen your experience, is also the reason why most people don't get far with their health, their recovery from mental illness or their success in life. 
...
We don't have balance in our ambitions. We don't truly understand what we're trying to achieve. We may not even be able to envision the outcome, neither have our physical health in order. 

Yes. 

If you are not eating healthily, nor getting enough exercise, you are blanatly ignoring the basics.

And this is where I believe most people go wrong. 

A lot of people assume the basics consist of working hard and nothing else. 

Ignoring everything else in life that is required to sustain us is the perfect way to create future problems.
...
They will spend all their time and energy toiling away, in the belief that their undetermined effort will always prevail over strategy.

The kind of person who will continue doing the same meaningless tasks, over and over again, even if they consciously know that it will have zero impact on their desired outcome.

People who believe they're immune to all the difficulties of success, such as self-promotion and maintaining focus on their goals. 

The kind of people who burn out after three months, become depressed and give up due to "change of mind". 

Who hold the unrightful belief that their actions are impenetrable to the common pitfalls of success, cause they idiots. 
...
It's different because you want nothing more than to crush the competition, and leave your mark on the world in the form of fat bank cheque and a shit-tonne of irreversible environmental damage.

Like running into a small African village with nothing more than a machine gun and a machette, to take out an entire generation of defenseless nomads  - sometimes we just want to dominate. 
...
Put simply, frameworks simply work - CAUSE THAT'S WHAT A FUCKING FRAMEWORK DOES, YO'LL.
...
In other words: Success is a system of structured processes, that enable us to work effectively towards our goals and ambitions.
...
- The process enables you to work hard.
- The hard work produces verifiable results. 

Now the key point here is work, because what's important to note is that these structured processes don't actually provide you with bucket-loads of success, straight to your door, with no additional fees. 

What it does provide you with is the ability to work harder and better than everyone else, which is ultimately how success is born.

Through time and hard work, the same constant we're all living through. 

Here is where it gets more crucial. 

The other key point is hard, and it's an incredibly important point that needs to be addressed ASAP. 

Hard work does not mean work that is laborious or demanding.

Anyone can do this so-called "hard" work, which is why it's not hard. It is merely unpleasant.  
...
And the demonstrable struggle that people exhibit with their success indicates that most people have been failing to do what's truly hard to obtain their success.

Because hard is working on your branding and marketing, and getting people to pay attention to you. 

Hard is working on your weaknesses that you refuse to admit - the things we suck at most. That's truly hard. 
...
Hell, there's content mills that charge people $3 per article to do this stuff. It's foolish to think that content will ever hold on it's own. 
...
If your framework cannot assist you in getting closer towards your goals, in addition to help you function 100% of the time, then it cannot be verifiable.

And if a system cannot be verified, quite simply, it cannot not work. 

Instead, unverifiable systems are the kinds of systems most of us dabble in. 

And is part of the reason why we end up burning out, losing interest and getting nowhere with our ambitions.
...
Ultimately I believe there are a few generalisations we can make on what bad systems are, and how we can avoid them.
...
On the other hand, this kind of information hiding isn't necessarily a bad thing, however only if our system is verifiable.

Because at the end of the day, over-thinking and worrying about the small details is counter-productive to our success.

The only cavet is that reflection and self-introspection is information for those starting out with building these systems, in order to gauge our progress. 

Of course, the beautiful thing about this is that verifiable systems work - so once you do find a working configuration, you can ultimately remain as unconscious to your schedule as much as you like - the routine simply carries you through. 
...
Now listen, a lot of this may seem very scary. 

I mean, how on earth am I supposed to know where I'm going to end up?

You learn. You study. Before you even hint at doing anything, you find out how. 
